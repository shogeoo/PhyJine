...
public class Main {
    static void main() {
        ...
        CircleCollider c1 = new CircleCollider(new Vector2D(0, 0), 0, 1, m);
        Body b = new Body(new Vector2D(0, 0), 0, c1);

        world.addBody(b);

        CircleCollider c3 = new CircleCollider(new Vector2D(0, 0), 0, 1, m);
        Body b2 = new Body(new Vector2D(0, 0), 0, c3);
